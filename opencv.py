...
plt.ion()
img_location = './database/tangram14.png'
...
print(coords)
target = Polygon(coords)
target = affinity.scale(target,sqrt(8/target.area), sqrt(8/target.area))
polygonrep.filled_poly_vizualize(target)
print(list(target.exterior.coords))
print(target.area)
